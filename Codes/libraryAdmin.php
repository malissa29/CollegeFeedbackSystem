...
<?php
 ...
 $con=  mysqli_connect("localhost","root","","feedback","3306");
   $canteenArray=array("Quality","Quantity","Availability","Variety","Staff","Hygiene");
...
<th>Grade</th>
 ...
 for($x=0;$x<$arrlength;$x++) {
 	$temp=$canteenArray[$x];
  $queryTwo=mysql_query("SELECT AVG(grade) FROM feedback.librarysave WHERE category='$temp'") or die(mysql_errno());
